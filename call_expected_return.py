...
def call_option_expected_return(contract_num, S, K, V, T, Div, target_holding_days, target_stk_price_chg, target_im_chg_pct):
    option_stk_unit = 100
    returned = bsm_pricing_call_return(S, K, V, T, Div)
    ...
    for t in subtract_list:
        theta = bsm_pricing_call_return(S, K, V, t, Div)[3]
